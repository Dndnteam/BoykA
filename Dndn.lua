...
SUDO = SUDO
sudo_users = {SUDO,931021223,694635826}   
print([[
┏┓━━━━━━━━━━━┏┓━━━━━━━━
┃┃━━━━━━━━━━━┃┃━━━━━━━━
┃┗━┓┏━━┓┏┓━┏┓┃┃┏┓┏━━┓         
...
io.popen("cd library && wget https://raw.githubusercontent.com/Dndnteam/Dndn/BoykA/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Dndnteam/files_Dndn/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DndnAW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DndnAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DndnAW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DndnAW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DndnAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DndnAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DndnAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(931021223) then  
var = true  
...
local UserName = (data.username_ or "DnDnTeam")
...
DnDn_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
DnDn_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
DnDn_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
DnDn_Msg = 'امبروطور التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@X_MGL_X")  
...
--------------------------------------------------------------------------------------------------------------
function SourceDnDn(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."DnDn1:List:Filter"..sl)
...
if not DndnAW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DndnAW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,DnDn_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✞|' and DndnAW(msg) then  
...
if text == 'تعطيل التواصل ✞|' and DndnAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✞|' and DndnAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✞|' and DndnAW(msg) then  
...
if text == 'ضع كليشه ستارت ✞|' and DndnAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✞|︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✞|' and DndnAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✞|︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✞|' and DndnAW(msg) then 
...
if text == 'تحديث السورس ✞|' and DndnAW(msg) then 
os.execute('rm -rf DnDn.lua')
os.execute('wget https://raw.githubusercontent.com/Dndnteam/Dndn/BoykA/Dndn.lua')
send(msg.chat_id_, msg.id_,' *✞|︙تم تحديث السورس* \n*✞|︙لديك اخر اصدار لسورس دندن*\n*✞|︙الاصدار » { 2.8v}*')
dofile('DnDn.lua')  
end
if text == 'الاصدار ✞|' and DndnAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✞|︙اصدار سورس دندن* \n*✞|︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✞|' and DndnAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✞|︙[تحديثات البوت](t.me/DnDnTeam) \n✞|︙[قناه السورس](t.me/DnDnTeam)')
end
if text == "ضع اسم للبوت ✞|" and DndnAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✞|︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✞|' and DndnAW(msg) then 
...
if text == 'المشتركين ✞|' and DndnAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✞|︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✞|' and DndnAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✞|︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✞|") and DndnAW(msg) then
...
if text == ("قائمه العام ✞|") and DndnAW(msg) then
...
if text == ("قائمه الكتم العام ✞|") and DndnAW(msg) then
...
if text=="اذاعه خاص ✞|" and msg.reply_to_message_id_ == 0 and DndnAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✞|︙ارسل الان اذاعتك؟* \n*✞|︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✞|" and msg.reply_to_message_id_ == 0 and DndnAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✞|︙ارسل الان اذاعتك؟* \n*✞|︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✞|" and msg.reply_to_message_id_ == 0 and DndnAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✞|︙ارسل الان اذاعتك؟* \n*✞|︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✞|" and msg.reply_to_message_id_ == 0  and DndnAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✞|︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✞|" and msg.reply_to_message_id_ == 0  and DndnAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✞|︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✞|' and DndnAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✞|" and DndnAW(msg) then
...
if text == "تنظيف الكروبات ✞|" and DndnAW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✞|︙عدد الكروبات الان » { '..#group..' }'..DnDnk..''..DnDn..'*\n*✞|︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DndnAW(msg) then
...
usertext = '*\n ✞|︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'DnDnTeam')..')'
status  = '\n *✞|︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DndnAW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✞|︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DnDnTeam')..')'
status  = '\n*✞|︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DndnAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DndnAW(msg) then
...
local DnDn1_Msg = database:get(bot_id.."DnDn1:Add:Filter:Rp2"..text..msg.chat_id_)   
if DnDn1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✞|︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DnDnTeam')..') \n ✞|︙'..DnDn1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if DnDn_Msg and not Special(msg) then  
local DnDn_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if DnDn_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✞|︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✞|︙["..DnDn_Msg.."] \n")
else
send(msg.chat_id_,0," *✞|︙العضو :* {["..data.first_name_.."](T.ME/DnDnTeam)}\n✞|︙["..DnDn_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✞|︙عذرا ↫* {["..data.first_name_.."](T.ME/DnDnTeam)}\n*✞|︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DndnAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DndnAW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DndnAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✞|︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DndnAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✞|︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✞|" and DndnAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✞|︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✞|$") and DndnAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✞|︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✞|" and DndnAW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✞|" and DndnAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✞|︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✞|" and DndnAW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."DnDn:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."DnDn:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_DnDn = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_DnDn then 
names_DnDn = database:smembers(bot_id.."DnDn:blocname"..msg.chat_id_) or ""
if names_DnDn and names_DnDn[1] then 
for i=1,#names_DnDn do 
if name_DnDn:match("(.*)("..names_DnDn[i]..")(.*)") then 
...
database:set(bot_id.."DnDn:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."DnDn:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."DnDn:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."DnDn:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."DnDn:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_DnDna_new(DnDn1,DnDn2)
if DnDn2 and DnDn2.first_name_ then 
if DnDn2.first_name_:match("(.*)"..database:get(bot_id.."DnDn:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DnDn:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local DnDn_nnn = database:get(bot_id.."DnDn:nump"..msg.chat_id_) or 5
local DnDn_nnn2 = database:get(bot_id.."DnDn:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(DnDn_nnn2) == tonumber(DnDn_nnn) or tonumber(DnDn_nnn2) > tonumber(DnDn_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DnDn:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✞|︙عزيزي >>["..DnDn2.username_.."](https://t.me/"..(DnDn2.username_ or "dndnteam")..")\n✞|︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DnDn:teh"..msg.chat_id_).."} بجانب اسمك\n✞|︙عدد المحاولات المتبقيه {"..(tonumber(DnDn_nnn) - tonumber(DnDn_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_DnDna_new)
end
end
...
local DnDnChengName = database:get(bot_id.."DnDn:Cheng:Name"..data.id_)
if not data.first_name_ then 
if DnDnChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DnDnChengName..']')
database:del(bot_id.."DnDn:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if DnDnChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."DnDn:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local DnDnChengUserName = database:get(bot_id.."DnDn:Cheng:UserName"..data.id_)
if not data.username_ then 
if DnDnChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..DnDnChengUserName..']')
database:del(bot_id.."DnDn:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if DnDnChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."DnDn:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DnDnChengPhoto = database:get(bot_id.."DnDn:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if DnDnChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."DnDn:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if DnDnChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."DnDn:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DndnAW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*✞|︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DnDnTeam')..') \n*✞|︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✞|︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DnDnTeam')..') \n*✞|︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DndnAW(msg) then
dofile('DnDn.lua')  
send(msg.chat_id_, msg.id_, ' *✞|︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DndnAW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DndnAW(msg) then  
function start_function(extra, result, success)
if DndnBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DndnAW(msg) then  
...
if text and text:match("^حظر عام (%d+)$") and DndnAW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if DndnBot(userid) then
send(msg.chat_id_, msg.id_,"*✞|︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DndnAW(msg) then  
function start_function(extra, result, success)
if DndnBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✞|︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DndnAW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DndnAW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if DndnBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✞|︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DndnAW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DndnAW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DndnAW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DndnAW(msg) then
...
if text == 'الملفات' and DndnAW(msg) then
t = ' *✞|︙ملفات السورس دندن ↓*\n*•━━━━━━ ᴅɴᴅɴ ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DndnAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Dndnteam/files_Dndn/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *✞|︙اهلا بك في متجر ملفات دندن*\n*✞|︙ملفات السورس ↓*\n*•━━━━━━ ᴅɴᴅɴ ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ ᴅɴᴅɴ ━━━━━━━•*\n *✞|︙علامة تعني { ✓ } ملف مفعل*\n *✞|︙علامة تعني { ✘ } ملف معطل*\n *✞|︙قناة سورس دندن ↓*\n".." *✞|︙*[اضغط هنا لدخول](t.me/DnDnTeam) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DndnAW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Dndnteam/files_Dndn/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DnDn.lua')  
else
send(msg.chat_id_, msg.id_," *✞|︙عذرا الملف لايدعم سورس دندن* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DndnAW(msg) then
...
if text == "مسح الملفات" and DndnAW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✞|︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DndnAW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DndnAW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "DnDnTeam")
...
function Function_DnDn(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DnDn, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_DnDn, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✞|︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'DnDnTeam')..')'
status  = '\n*✞|︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✞|︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DnDnTeam')..')'
status  = '\n*✞|︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✞|︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✞|︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DnDnTeam')..')'
...
database:set(bot_id.."DnDn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."DnDn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✞|︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."DnDn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."DnDn1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."DnDn1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."DnDn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✞|︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."DnDn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."DnDn1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."DnDn1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."DnDn1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✞|︙ارسل الكلمه الان*")  
database:set(bot_id.."DnDn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DnDn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."DnDn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DnDn1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."DnDn1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."DnDn1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."DnDn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DnDn1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."DnDn1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DndnAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✞|︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DndnAW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✞|︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'DnDnTeam')..')'..'\n*✞|︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DndnAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DndnAW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'دندن').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'دندن')
local DnDn_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..DnDn_Msg[math.random(#DnDn_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DndnAW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,DnDn)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ ᴅɴᴅɴ ━━━━━━━•*\n"
x = 0
local list = DnDn.members_
for k, v in pairs(list) do
x = x + 1
...
if DndnBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DndnAW(msg) then 
...
if text == ("ردود المطور") and DndnAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✞|︙قائمة ردود المطور \n*•━━━━━━ ᴅɴᴅɴ ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DndnAW(msg) then    
send(msg.chat_id_, msg.id_,' *✞|︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DndnAW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'دندن').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DndnAW(msg) then   
...
if text == 'تعطيل المغادره' and DndnAW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'DnDnTeam')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
DnDndx(msg.chat_id_, msg.id_, ' *✞|︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✞|︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✞|︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✞|︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DndnAW(msg) then
...
*✞|م10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ ᴅɴᴅɴ ━━━━━━━•*ٴ
[- sᴏᴜʀᴄʀ ᴅɴᴅɴ ᴛᴇᴀᴍ ](t.me/DnDnTeam) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '- sᴏᴜʀᴄʀ ᴅɴᴅɴ ᴛᴇᴀᴍ', url="t.me/DnDnTeam"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '- sᴏᴜʀᴄʀ ᴅɴᴅɴ ᴛᴇᴀᴍ', url="t.me/DnDnTeam"}},
{{text = 'مطور السورس', url="t.me/X_MGL_X"}},
}
...
send(msg.chat_id_, msg.id_, t..'ٴ✞|∫ٴ*•━━━━━━ ᴅɴᴅɴ ━━━━━━━•*ٴ✞|∫○ٴ\n✞|︙[- sᴏᴜʀᴄʀ ᴅɴᴅɴ ᴛᴇᴀᴍ](t.me/DnDnTeam) ')
end
...
{{text = '~ DnDn •',url='http://t.me/DnDnTeam'}},
}
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴅɴᴅɴ ᴛᴇᴀᴍ',url='http://t.me/DnDnTeam'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'دندن')
...
DnDn = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(DnDn)
...
------------------------------------------------------------------------
local DnDnAbot = database:get(bot_id.."DnDn1:Add:Filter:Rp2"..text..result.chat_id_)   
if DnDnAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✞|︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✞|︙["..DnDnAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local DnDn1_Msg = database:get(bot_id.."DnDn1:Add:Filter:Rp2"..text..result.chat_id_)   
if DnDn1_Msg then
send(msg.chat_id_, msg.id_," ✞|︙"..DnDn1_Msg)
